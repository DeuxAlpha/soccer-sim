...
// var context = new SoccerSimContext();
   ...
   //  
   //  context = new SoccerSimContext();
   //  var belgianFirstDivisionA2017 = GetFixtures("2017-2018", "B1");
   //  await StoreLeagueInfo(context, belgianFirstDivisionA2017, "2017-2018", "Belgium", "First Division A", 1);
   //  
   //  context = new SoccerSimContext();
   //  var germanBundesliga2017 = GetFixtures("2017-2018", "D1");
   //  await StoreLeagueInfo(context, germanBundesliga2017, "2017-2018", "Germany", "Bundesliga", 1);
   //  
   //  context = new SoccerSimContext();
   //  var german2Bundesliga2017 = GetFixtures("2017-2018", "D2");
   //  await StoreLeagueInfo(context, german2Bundesliga2017, "2017-2018", "Germany", "2. Bundesliga", 2);
   //  
   //  context = new SoccerSimContext();
   //  var englishPremierLeague2017 = GetFixtures("2017-2018", "E0");
   //  await StoreLeagueInfo(context, englishPremierLeague2017, "2017-2018", "England", "Premier League", 1);
   //  
   //  context = new SoccerSimContext();
   //  var englishChampionship2017 = GetFixtures("2017-2018", "E1");
   //  await StoreLeagueInfo(context, englishChampionship2017, "2017-2018", "England", "Championship", 2);
   //  
   //  context = new SoccerSimContext();
   //  var englishLeagueOne2017 = GetFixtures("2017-2018", "E2");
   //  await StoreLeagueInfo(context, englishLeagueOne2017, "2017-2018", "England", "League One", 3);
   //  
   //  context = new SoccerSimContext();
   //  var englishLeagueTwo2017 = GetFixtures("2017-2018", "E3");
   //  await StoreLeagueInfo(context, englishLeagueTwo2017, "2017-2018", "England", "League Two", 4);
   //  
   //  context = new SoccerSimContext();
   //  var frenchLigue12017 = GetFixtures("2017-2018", "F1");
   //  await StoreLeagueInfo(context, frenchLigue12017, "2017-2018", "France", "Ligue 1", 1);
   //  
   //  context = new SoccerSimContext();
   //  var frenchLigue22017 = GetFixtures("2017-2018", "F2");
   //  await StoreLeagueInfo(context, frenchLigue22017, "2017-2018", "France", "Ligue 2", 2);
   //
   // context = new SoccerSimContext();
   //  var greekSuperLeague2017 = GetFixtures("2017-2018", "G1");
   //  await StoreLeagueInfo(context, greekSuperLeague2017, "2017-2018", "Greece", "Super League", 1);
   //  
   //  context = new SoccerSimContext();
   //  var italianSerieA2017 = GetFixtures("2017-2018", "I1");
   //  await StoreLeagueInfo(context, italianSerieA2017, "2017-2018", "Italy", "Serie A", 1);
   //  
   //  context = new SoccerSimContext();
   //  var italianSerieB2017 = GetFixtures("2017-2018", "I2");
   //  await StoreLeagueInfo(context, italianSerieB2017, "2017-2018", "Italy", "Serie B", 2);
   //  
   //  context = new SoccerSimContext();
   //  var dutchEredivisie2017 = GetFixtures("2017-2018", "N1");
   //  await StoreLeagueInfo(context, dutchEredivisie2017, "2017-2018", "Netherlands", "Eredivisie", 1);
   //  
   //  context = new SoccerSimContext();
   //  var portuguesePrimeiraLiga2017 = GetFixtures("2017-2018", "P1");
   //  await StoreLeagueInfo(context, portuguesePrimeiraLiga2017, "2017-2018", "Portugal", "Primeira Liga", 1);
   //
   //  context = new SoccerSimContext();
   //  var scottishPremiership2017 = GetFixtures("2017-2018", "SC0");
   //  await StoreLeagueInfo(context, scottishPremiership2017, "2017-2018", "Scotland", "Premiership", 1);
   //  
   //  context = new SoccerSimContext();
   //  var scottishChampionship2017 = GetFixtures("2017-2018", "SC1");
   //  await StoreLeagueInfo(context, scottishChampionship2017, "2017-2018", "Scotland", "Championship", 2);
   //  
   //  context = new SoccerSimContext();
   //  var scottishLeagueOne2017 = GetFixtures("2017-2018", "SC2");
   //  await StoreLeagueInfo(context, scottishLeagueOne2017, "2017-2018", "Scotland", "League One", 3);
   //  
   //  context = new SoccerSimContext();
   //  var scottishLeagueTwo2017 = GetFixtures("2017-2018", "SC3");
   //  await StoreLeagueInfo(context, scottishLeagueTwo2017, "2017-2018", "Scotland", "League Two", 4);
   //  
   //  context = new SoccerSimContext();
   //  var spanishPrimeraDivision2017 = GetFixtures("2017-2018", "SP1");
   //  await StoreLeagueInfo(context, spanishPrimeraDivision2017, "2017-2018", "Spain", "Primera Division", 1);
   //  
   //  context = new SoccerSimContext();
   //  var spanishSegundaDivision2017 = GetFixtures("2017-2018", "SP2");
   //  await StoreLeagueInfo(context, spanishSegundaDivision2017, "2017-2018", "Spain", "Segunda Division", 2);
   //  
   //  context = new SoccerSimContext();
   //  var turkishSuperLig2017 = GetFixtures("2017-2018", "T1");
   //  await StoreLeagueInfo(context, turkishSuperLig2017, "2017-2018", "Turkey", "Super Lig", 1);
   //
   //  #endregion
   //  
   //  #region 2018
   //
   //  context = new SoccerSimContext();
   //  var belgianFirstDivisionA2018 = GetFixtures("2018-2019", "B1");
   //  await StoreLeagueInfo(context, belgianFirstDivisionA2018, "2018-2019", "Belgium", "First Division A", 1);
   //  
   //  context = new SoccerSimContext();
   //  var germanBundesliga2018 = GetFixtures("2018-2019", "D1");
   //  await StoreLeagueInfo(context, germanBundesliga2018, "2018-2019", "Germany", "Bundesliga", 1);
   //  
   //  context = new SoccerSimContext();
   //  var german2Bundesliga2018 = GetFixtures("2018-2019", "D2");
   //  await StoreLeagueInfo(context, german2Bundesliga2018, "2018-2019", "Germany", "2. Bundesliga", 2);
   //  
   //  context = new SoccerSimContext();
   //  var englishPremierLeague2018 = GetFixtures("2018-2019", "E0");
   //  await StoreLeagueInfo(context, englishPremierLeague2018, "2018-2019", "England", "Premier League", 1);
   //  
   //  context = new SoccerSimContext();
   //  var englishChampionship2018 = GetFixtures("2018-2019", "E1");
   //  await StoreLeagueInfo(context, englishChampionship2018, "2018-2019", "England", "Championship", 2);
   //  
   //  context = new SoccerSimContext();
   //  var englishLeagueOne2018 = GetFixtures("2018-2019", "E2");
   //  await StoreLeagueInfo(context, englishLeagueOne2018, "2018-2019", "England", "League One", 3);
   //  
   //  context = new SoccerSimContext();
   //  var englishLeagueTwo2018 = GetFixtures("2018-2019", "E3");
   //  await StoreLeagueInfo(context, englishLeagueTwo2018, "2018-2019", "England", "League Two", 4);
   //  
   //  context = new SoccerSimContext();
   //  var englishNationalLeague2018 = GetFixtures("2018-2019", "EC");
   //  await StoreLeagueInfo(context, englishNationalLeague2018, "2018-2019", "England", "National League", 5);
   //  
   //  context = new SoccerSimContext();
   //  var frenchLigue12018 = GetFixtures("2018-2019", "F1");
   //  await StoreLeagueInfo(context, frenchLigue12018, "2018-2019", "France", "Ligue 1", 1);
   //  
   //  context = new SoccerSimContext();
   //  var frenchLigue22018 = GetFixtures("2018-2019", "F2");
   //  await StoreLeagueInfo(context, frenchLigue22018, "2018-2019", "France", "Ligue 2", 2);
   //
   //  context = new SoccerSimContext();
   //  var greekSuperLeague2018 = GetFixtures("2018-2019", "G1");
   //  await StoreLeagueInfo(context, greekSuperLeague2018, "2018-2019", "Greece", "Super League", 1);
   //
   //  context = new SoccerSimContext();
   //  var italianSerieA2018 = GetFixtures("2018-2019", "I1");
   //  await StoreLeagueInfo(context, italianSerieA2018, "2018-2019", "Italy", "Serie A", 1);
   //  
   //  context = new SoccerSimContext();
   //  var italianSerieB2018 = GetFixtures("2018-2019", "I2");
   //  await StoreLeagueInfo(context, italianSerieB2018, "2018-2019", "Italy", "Serie B", 2);
   //  
   //  context = new SoccerSimContext();
   //  var dutchEredivisie2018 = GetFixtures("2018-2019", "N1");
   //  await StoreLeagueInfo(context, dutchEredivisie2018, "2018-2019", "Netherlands", "Eredivisie", 1);
   //  
   //  context = new SoccerSimContext();
   //  var portuguesePrimeiraLiga2018 = GetFixtures("2018-2019", "P1");
   //  await StoreLeagueInfo(context, portuguesePrimeiraLiga2018, "2018-2019", "Portugal", "Primeira Liga", 1);
   //  
   //  context = new SoccerSimContext();
   //  var scottishPremiership2018 = GetFixtures("2018-2019", "SC0");
   //  await StoreLeagueInfo(context, scottishPremiership2018, "2018-2019", "Scotland", "Premiership", 1);
   //  
   //  context = new SoccerSimContext();
   //  var scottishChampionship2018 = GetFixtures("2018-2019", "SC1");
   //  await StoreLeagueInfo(context, scottishChampionship2018, "2018-2019", "Scotland", "Championship", 2);
   //  
   //  context = new SoccerSimContext();
   //  var scottishLeagueOne2018 = GetFixtures("2018-2019", "SC2");
   //  await StoreLeagueInfo(context, scottishLeagueOne2018, "2018-2019", "Scotland", "League One", 3);
   //  
   //  context = new SoccerSimContext();
   //  var scottishLeagueTwo2018 = GetFixtures("2018-2019", "SC3");
   //  await StoreLeagueInfo(context, scottishLeagueTwo2018, "2018-2019", "Scotland", "League Two", 4);
   //  
   //  context = new SoccerSimContext();
   //  var spanishLaLiga2018 = GetFixtures("2018-2019", "SP1");
   //  await StoreLeagueInfo(context, spanishLaLiga2018, "2018-2019", "Spain", "La Liga", 1);
   //  
   //  context = new SoccerSimContext();
   //  var spanishSegundaDivision2018 = GetFixtures("2018-2019", "SP2");
   //  await StoreLeagueInfo(context, spanishSegundaDivision2018, "2018-2019", "Spain", "Segunda Division", 2);
   //  
   //  context = new SoccerSimContext();
   //  var turkishSuperLig2018 = GetFixtures("2018-2019", "T1");
   //  await StoreLeagueInfo(context, turkishSuperLig2018, "2018-2019", "Turkey", "Super Lig", 1);
   //
   //  #endregion
    ...
    //
    // var context = new SoccerSimContext();
    // var belgianFirstDivisionA2019 = GetFixtures2020("2019-2020", "B1");
    // await StoreLeagueInfo2020(context, belgianFirstDivisionA2019, "2019-2020", "Belgium", "First Division A", 1);
    //
    // context = new SoccerSimContext();
    // var germanBundesliga2019 = GetFixtures2020("2019-2020", "D1");  
    // await StoreLeagueInfo2020(context, germanBundesliga2019, "2019-2020", "Germany", "Bundesliga", 1);
    //
    // context = new SoccerSimContext();
    // var germanBundesliga22019 = GetFixtures2020("2019-2020", "D2");
    // await StoreLeagueInfo2020(context, germanBundesliga22019, "2019-2020", "Germany", "Bundesliga 2", 2);
    //
    // context = new SoccerSimContext();
    // var englishPremierLeague2019 = GetFixtures2020("2019-2020", "E0");
    // await StoreLeagueInfo2020(context, englishPremierLeague2019, "2019-2020", "England", "Premier League", 1);
    //
    // context = new SoccerSimContext();
    // var englishChampionship2019 = GetFixtures2020("2019-2020", "E1");
    // await StoreLeagueInfo2020(context, englishChampionship2019, "2019-2020", "England", "Championship", 2);
    //
    // context = new SoccerSimContext();
    // var englishLeagueOne2019 = GetFixtures2020("2019-2020", "E2");
    // await StoreLeagueInfo2020(context, englishLeagueOne2019, "2019-2020", "England", "League One", 3);
    //
    // context = new SoccerSimContext();
    // var englishLeagueTwo2019 = GetFixtures2020("2019-2020", "E3");
    // await StoreLeagueInfo2020(context, englishLeagueTwo2019, "2019-2020", "England", "League Two", 4);
    //
    // context = new SoccerSimContext();
    // var englishConference2019 = GetFixtures2020("2019-2020", "EC");
    // await StoreLeagueInfo2020(context, englishConference2019, "2019-2020", "England", "Conference", 5);
    //
    // context = new SoccerSimContext();
    // var frenchLigue12019 = GetFixtures2020("2019-2020", "F1");
    // await StoreLeagueInfo2020(context, frenchLigue12019, "2019-2020", "France", "Ligue 1", 1);
    //
    // context = new SoccerSimContext();
    // var frenchLigue22019 = GetFixtures2020("2019-2020", "F2");
    // await StoreLeagueInfo2020(context, frenchLigue22019, "2019-2020", "France", "Ligue 2", 2);
    //
    // context = new SoccerSimContext();
    // var greecesuperLeague2019 = GetFixtures2020("2019-2020", "G1");
    // await StoreLeagueInfo2020(context, greecesuperLeague2019, "2019-2020", "Greece", "Super League", 1);
    //
    // context = new SoccerSimContext();
    // var italianSerieA2019 = GetFixtures2020("2019-2020", "I1");
    // await StoreLeagueInfo2020(context, italianSerieA2019, "2019-2020", "Italy", "Serie A", 1);
    //
    // context = new SoccerSimContext();
    // var italianSerieB2019 = GetFixtures2020("2019-2020", "I2");
    // await StoreLeagueInfo2020(context, italianSerieB2019, "2019-2020", "Italy", "Serie B", 2);
    //
    // context = new SoccerSimContext();
    // var dutchEredivisie2019 = GetFixtures2020("2019-2020", "N1");
    // await StoreLeagueInfo2020(context, dutchEredivisie2019, "2019-2020", "Netherlands", "Eredivisie", 1);
    //
    // context = new SoccerSimContext();
    // var portuguesePrimeiraLiga2019 = GetFixtures2020("2019-2020", "P1");
    // await StoreLeagueInfo2020(context, portuguesePrimeiraLiga2019, "2019-2020", "Portugal", "Primeira Liga", 1);
    //
    // context = new SoccerSimContext();
    // var scottishPremiership2019 = GetFixtures2020("2019-2020", "SC0");
    // await StoreLeagueInfo2020(context, scottishPremiership2019, "2019-2020", "Scotland", "Premiership", 1);
    //
    // context = new SoccerSimContext();
    // var scottishChampionship2019 = GetFixtures2020("2019-2020", "SC1");
    // await StoreLeagueInfo2020(context, scottishChampionship2019, "2019-2020", "Scotland", "Championship", 2);
    //
    // context = new SoccerSimContext();
    // var scottishLeagueOne2019 = GetFixtures2020("2019-2020", "SC2");
    // await StoreLeagueInfo2020(context, scottishLeagueOne2019, "2019-2020", "Scotland", "League One", 3);
    //
    // context = new SoccerSimContext();
    // var scottishLeagueTwo2019 = GetFixtures2020("2019-2020", "SC3");
    // await StoreLeagueInfo2020(context, scottishLeagueTwo2019, "2019-2020", "Scotland", "League Two", 4);
    //
    // context = new SoccerSimContext();
    // var spanishPrimeraDivision2019 = GetFixtures2020("2019-2020", "SP1");
    // await StoreLeagueInfo2020(context, spanishPrimeraDivision2019, "2019-2020", "Spain", "Primera Division", 1);
    //
    // context = new SoccerSimContext();
    // var spanishSegundaDivision2019 = GetFixtures2020("2019-2020", "SP2");
    // await StoreLeagueInfo2020(context, spanishSegundaDivision2019, "2019-2020", "Spain", "Segunda Division", 2);
    //
    // context = new SoccerSimContext();
    // var turkishSuperLig2019 = GetFixtures2020("2019-2020", "T1");
    // await StoreLeagueInfo2020(context, turkishSuperLig2019, "2019-2020", "Turkey", "Super Lig", 1);
    //
    // #endregion
    //
    // #region 2020
    //
    // context = new SoccerSimContext();
    // var belgianFirstDivisionA2020 = GetFixtures2020("2020-2021", "B1");
    // await StoreLeagueInfo2020(context, belgianFirstDivisionA2020, "2020-2021", "Belgium", "First Division A", 1);
    //
    // context = new SoccerSimContext();
    // var germanBundesliga2020 = GetFixtures2020("2020-2021", "D1");
    // await StoreLeagueInfo2020(context, germanBundesliga2020, "2020-2021", "Germany", "Bundesliga", 1);
    //
    // context = new SoccerSimContext();
    // var germanBundesliga22020 = GetFixtures2020("2020-2021", "D2");
    // await StoreLeagueInfo2020(context, germanBundesliga22020, "2020-2021", "Germany", "Bundesliga 2", 2);
    //
    // context = new SoccerSimContext();
    // var englishPremierLeague2020 = GetFixtures2020("2020-2021", "E0");
    // await StoreLeagueInfo2020(context, englishPremierLeague2020, "2020-2021", "England", "Premier League", 1);
    //
    // context = new SoccerSimContext();
    // var englishChampionship2020 = GetFixtures2020("2020-2021", "E1");
    // await StoreLeagueInfo2020(context, englishChampionship2020, "2020-2021", "England", "Championship", 2);
    //
    // context = new SoccerSimContext();
    // var englishLeagueOne2020 = GetFixtures2020("2020-2021", "E2");
    // await StoreLeagueInfo2020(context, englishLeagueOne2020, "2020-2021", "England", "League One", 3);
    //
    // context = new SoccerSimContext();
    // var englishLeagueTwo2020 = GetFixtures2020("2020-2021", "E3");
    // await StoreLeagueInfo2020(context, englishLeagueTwo2020, "2020-2021", "England", "League Two", 4);
    //
    // context = new SoccerSimContext();
    // var englishConference2020 = GetFixtures2020("2020-2021", "EC");
    // await StoreLeagueInfo2020(context, englishConference2020, "2020-2021", "England", "Conference", 5);
    //
    // context = new SoccerSimContext();
    // var frenchLigue12020 = GetFixtures2020("2020-2021", "F1");
    // await StoreLeagueInfo2020(context, frenchLigue12020, "2020-2021", "France", "Ligue 1", 1);
    //
    // context = new SoccerSimContext();
    // var frenchLigue22020 = GetFixtures2020("2020-2021", "F2");
    // await StoreLeagueInfo2020(context, frenchLigue22020, "2020-2021", "France", "Ligue 2", 2);
    //
    // context = new SoccerSimContext();
    // var greecesuperLeague2020 = GetFixtures2020("2020-2021", "G1");
    // await StoreLeagueInfo2020(context, greecesuperLeague2020, "2020-2021", "Greece", "Super League", 1);
    //
    // context = new SoccerSimContext();
    // var italianSerieA2020 = GetFixtures2020("2020-2021", "I1");
    // await StoreLeagueInfo2020(context, italianSerieA2020, "2020-2021", "Italy", "Serie A", 1);
    //
    // context = new SoccerSimContext();
    // var italianSerieB2020 = GetFixtures2020("2020-2021", "I2");
    // await StoreLeagueInfo2020(context, italianSerieB2020, "2020-2021", "Italy", "Serie B", 2);
    //
    // context = new SoccerSimContext();
    // var dutchEredivisie2020 = GetFixtures2020("2020-2021", "N1");
    // await StoreLeagueInfo2020(context, dutchEredivisie2020, "2020-2021", "Netherlands", "Eredivisie", 1);
    //
    // context = new SoccerSimContext();
    // var portugueseLiga2020 = GetFixtures2020("2020-2021", "P1");
    // await StoreLeagueInfo2020(context, portugueseLiga2020, "2020-2021", "Portugal", "Liga", 1);
    //
    // context = new SoccerSimContext();
    // var scottishPremiership2020 = GetFixtures2020("2020-2021", "SC0");
    // await StoreLeagueInfo2020(context, scottishPremiership2020, "2020-2021", "Scotland", "Premiership", 1);
    //
    // context = new SoccerSimContext();
    // var scottishChampionship2020 = GetFixtures2020("2020-2021", "SC1");
    // await StoreLeagueInfo2020(context, scottishChampionship2020, "2020-2021", "Scotland", "Championship", 2);
    //
    // context = new SoccerSimContext();
    // var scottishLeagueOne2020 = GetFixtures2020("2020-2021", "SC2");
    // await StoreLeagueInfo2020(context, scottishLeagueOne2020, "2020-2021", "Scotland", "League One", 3);
    //
    // context = new SoccerSimContext();
    // var scottishLeagueTwo2020 = GetFixtures2020("2020-2021", "SC3");
    // await StoreLeagueInfo2020(context, scottishLeagueTwo2020, "2020-2021", "Scotland", "League Two", 4);
    //
    // context = new SoccerSimContext();
    // var spanishPrimeraDivision2020 = GetFixtures2020("2020-2021", "SP1");
    // await StoreLeagueInfo2020(context, spanishPrimeraDivision2020, "2020-2021", "Spain", "Primera Division", 1);
    //
    // context = new SoccerSimContext();
    // var spanishSegundaDivision2020 = GetFixtures2020("2020-2021", "SP2");
    // await StoreLeagueInfo2020(context, spanishSegundaDivision2020, "2020-2021", "Spain", "Segunda Division", 2);
    //
    // context = new SoccerSimContext();
    // var turkishSuperLig2020 = GetFixtures2020("2020-2021", "T1");
    // await StoreLeagueInfo2020(context, turkishSuperLig2020, "2020-2021", "Turkey", "Super Lig", 1);
    //
    // #endregion
    //
    // #region 2021
    //
    // context = new SoccerSimContext();
    // var belgianFirstDivisionA2021 = GetFixtures2020("2021-2022", "B1");
    // await StoreLeagueInfo2020(context, belgianFirstDivisionA2021, "2021-2022", "Belgium", "First Division A", 1);
    //
    // context = new SoccerSimContext();
    // var germanBundesliga2021 = GetFixtures2020("2021-2022", "D1");
    // await StoreLeagueInfo2020(context, germanBundesliga2021, "2021-2022", "Germany", "Bundesliga", 1);
    //
    // context = new SoccerSimContext();
    // var germanBundesliga22021 = GetFixtures2020("2021-2022", "D2");
    // await StoreLeagueInfo2020(context, germanBundesliga22021, "2021-2022", "Germany", "Bundesliga 2", 2);
    //
    // context = new SoccerSimContext();
    // var englishPremierLeague2021 = GetFixtures2020("2021-2022", "E0");
    // await StoreLeagueInfo2020(context, englishPremierLeague2021, "2021-2022", "England", "Premier League", 1);
    //
    // context = new SoccerSimContext();
    // var englishChampionship2021 = GetFixtures2020("2021-2022", "E1");
    // await StoreLeagueInfo2020(context, englishChampionship2021, "2021-2022", "England", "Championship", 2);
    //
    // context = new SoccerSimContext();
    // var englishLeagueOne2021 = GetFixtures2020("2021-2022", "E2");
    // await StoreLeagueInfo2020(context, englishLeagueOne2021, "2021-2022", "England", "League One", 3);
    //
    // context = new SoccerSimContext();
    // var englishLeagueTwo2021 = GetFixtures2020("2021-2022", "E3");
    // await StoreLeagueInfo2020(context, englishLeagueTwo2021, "2021-2022", "England", "League Two", 4);
    //
    // context = new SoccerSimContext();
    // var englishNationalLeague2021 = GetFixtures2020("2021-2022", "EC");
    // await StoreLeagueInfo2020(context, englishNationalLeague2021, "2021-2022", "England", "National League", 5);
    //
    // context = new SoccerSimContext();
    // var frenchLigue12021 = GetFixtures2020("2021-2022", "F1");
    // await StoreLeagueInfo2020(context, frenchLigue12021, "2021-2022", "France", "Ligue 1", 1);
    //
    // context = new SoccerSimContext();
    // var frenchLigue22021 = GetFixtures2020("2021-2022", "F2");
    // await StoreLeagueInfo2020(context, frenchLigue22021, "2021-2022", "France", "Ligue 2", 2);
    //
    // context = new SoccerSimContext();
    // var greecesuperLeague2021 = GetFixtures2020("2021-2022", "G1");
    // await StoreLeagueInfo2020(context, greecesuperLeague2021, "2021-2022", "Greece", "Super League", 1);
    //
    // context = new SoccerSimContext();
    // var italianSerieA2021 = GetFixtures2020("2021-2022", "I1");
    // await StoreLeagueInfo2020(context, italianSerieA2021, "2021-2022", "Italy", "Serie A", 1);
    //
    // context = new SoccerSimContext();
    // var italianSerieB2021 = GetFixtures2020("2021-2022", "I2");
    // await StoreLeagueInfo2020(context, italianSerieB2021, "2021-2022", "Italy", "Serie B", 2);
    //
    // context = new SoccerSimContext();
    // var dutchEredivisie2021 = GetFixtures2020("2021-2022", "N1");
    // await StoreLeagueInfo2020(context, dutchEredivisie2021, "2021-2022", "Netherlands", "Eredivisie", 1);
    //
    // context = new SoccerSimContext();
    // var portuguesePrimeiraLiga2021 = GetFixtures2020("2021-2022", "P1");
    // await StoreLeagueInfo2020(context, portuguesePrimeiraLiga2021, "2021-2022", "Portugal", "Primeira Liga", 1);
    //
    // context = new SoccerSimContext();
    // var scottishPremiership2021 = GetFixtures2020("2021-2022", "SC0");
    // await StoreLeagueInfo2020(context, scottishPremiership2021, "2021-2022", "Scotland", "Premiership", 1);
    //
    // context = new SoccerSimContext();
    // var scottishChampionship2021 = GetFixtures2020("2021-2022", "SC1");
    // await StoreLeagueInfo2020(context, scottishChampionship2021, "2021-2022", "Scotland", "Championship", 2);
    //
    // context = new SoccerSimContext();
    // var scottishLeagueOne2021 = GetFixtures2020("2021-2022", "SC2");
    // await StoreLeagueInfo2020(context, scottishLeagueOne2021, "2021-2022", "Scotland", "League One", 3);
    //
    // context = new SoccerSimContext();
    // var scottishLeagueTwo2021 = GetFixtures2020("2021-2022", "SC3");
    // await StoreLeagueInfo2020(context, scottishLeagueTwo2021, "2021-2022", "Scotland", "League Two", 4);
    //
    // context = new SoccerSimContext();
    // var spanishLaLiga2021 = GetFixtures2020("2021-2022", "SP1");
    // await StoreLeagueInfo2020(context, spanishLaLiga2021, "2021-2022", "Spain", "La Liga", 1);
    //
    // context = new SoccerSimContext();
    // var spanishSegundaDivision2021 = GetFixtures2020("2021-2022", "SP2");
    // await StoreLeagueInfo2020(context, spanishSegundaDivision2021, "2021-2022", "Spain", "Segunda Division", 2);
    //
    // context = new SoccerSimContext();
    // var turkishSuperLig2021 = GetFixtures2020("2021-2022", "T1");
    // await StoreLeagueInfo2020(context, turkishSuperLig2021, "2021-2022", "Turkey", "Super Lig", 1);
    ...
    var context = new SoccerSimContext();
    var belgianFirstDivisionA2022 = GetFixtures2020("2022-2023", "B1");
    await StoreLeagueInfo2020(context, belgianFirstDivisionA2022, "2022-2023", "Belgium", "First Division A", 1);
    
    context = new SoccerSimContext();
    var germanBundesliga2022 = GetFixtures2020("2022-2023", "D1");
    await StoreLeagueInfo2020(context, germanBundesliga2022, "2022-2023", "Germany", "Bundesliga", 1);
    
    context = new SoccerSimContext();
    var german2Bundesliga2022 = GetFixtures2020("2022-2023", "D2");
    await StoreLeagueInfo2020(context, german2Bundesliga2022, "2022-2023", "Germany", "2. Bundesliga", 2);
    
    context = new SoccerSimContext();
    var englishPremierLeague2022 = GetFixtures2020("2022-2023", "E0");
    await StoreLeagueInfo2020(context, englishPremierLeague2022, "2022-2023", "England", "Premier League", 1);
    
    context = new SoccerSimContext();
    var englishChampionship2022 = GetFixtures2020("2022-2023", "E1");
    await StoreLeagueInfo2020(context, englishChampionship2022, "2022-2023", "England", "Championship", 2);
    
    context = new SoccerSimContext();
    var englishLeagueOne2022 = GetFixtures2020("2022-2023", "E2");
    await StoreLeagueInfo2020(context, englishLeagueOne2022, "2022-2023", "England", "League One", 3);
    
    context = new SoccerSimContext();
    var englishLeagueTwo2022 = GetFixtures2020("2022-2023", "E3");
    await StoreLeagueInfo2020(context, englishLeagueTwo2022, "2022-2023", "England", "League Two", 4);
    
    context = new SoccerSimContext();
    var englishConference2022 = GetFixtures2020("2022-2023", "EC");
    await StoreLeagueInfo2020(context, englishConference2022, "2022-2023", "England", "Conference", 5);
    
    context = new SoccerSimContext();
    var frenchLigue12022 = GetFixtures2020("2022-2023", "F1");
    await StoreLeagueInfo2020(context, frenchLigue12022, "2022-2023", "France", "Ligue 1", 1);
    
    context = new SoccerSimContext();
    var frenchLigue22022 = GetFixtures2020("2022-2023", "F2");
    await StoreLeagueInfo2020(context, frenchLigue22022, "2022-2023", "France", "Ligue 2", 2);
    
    context = new SoccerSimContext();
    var greecesuperLeague2022 = GetFixtures2020("2022-2023", "G1");
    await StoreLeagueInfo2020(context, greecesuperLeague2022, "2022-2023", "Greece", "Super League", 1);
    
    context = new SoccerSimContext();
    var italianserieA2022 = GetFixtures2020("2022-2023", "I1");
    await StoreLeagueInfo2020(context, italianserieA2022, "2022-2023", "Italy", "Serie A", 1);
    
    context = new SoccerSimContext();
    var italianserieB2022 = GetFixtures2020("2022-2023", "I2");
    await StoreLeagueInfo2020(context, italianserieB2022, "2022-2023", "Italy", "Serie B", 2);
    
    context = new SoccerSimContext();
    var dutchEredivisie2022 = GetFixtures2020("2022-2023", "N1");
    await StoreLeagueInfo2020(context, dutchEredivisie2022, "2022-2023", "Netherlands", "Eredivisie", 1);
    
    context = new SoccerSimContext();
    var portuguesePrimeiraLiga2022 = GetFixtures2020("2022-2023", "P1");
    await StoreLeagueInfo2020(context, portuguesePrimeiraLiga2022, "2022-2023", "Portugal", "Primeira Liga", 1);
    
    context = new SoccerSimContext();
    var scottishPremiership2022 = GetFixtures2020("2022-2023", "SC0");
    await StoreLeagueInfo2020(context, scottishPremiership2022, "2022-2023", "Scotland", "Premiership", 1);
    
    context = new SoccerSimContext();
    var scottishChampionship2022 = GetFixtures2020("2022-2023", "SC1");
    await StoreLeagueInfo2020(context, scottishChampionship2022, "2022-2023", "Scotland", "Championship", 2);
    
    context = new SoccerSimContext();
    var scottishLeagueOne2022 = GetFixtures2020("2022-2023", "SC2");
    await StoreLeagueInfo2020(context, scottishLeagueOne2022, "2022-2023", "Scotland", "League One", 3);
    
    context = new SoccerSimContext();
    var scottishLeagueTwo2022 = GetFixtures2020("2022-2023", "SC3");
    await StoreLeagueInfo2020(context, scottishLeagueTwo2022, "2022-2023", "Scotland", "League Two", 4);
    
    context = new SoccerSimContext();
    var spanishPrimeraDivision2022 = GetFixtures2020("2022-2023", "SP1");
    await StoreLeagueInfo2020(context, spanishPrimeraDivision2022, "2022-2023", "Spain", "Primera Division", 1);
    
    context = new SoccerSimContext();
    var spanishSegundaDivision2022 = GetFixtures2020("2022-2023", "SP2");
    await StoreLeagueInfo2020(context, spanishSegundaDivision2022, "2022-2023", "Spain", "Segunda Division", 2);
    
    context = new SoccerSimContext();
    var turkishSuperLig2022 = GetFixtures2020("2022-2023", "T1");
    await StoreLeagueInfo2020(context, turkishSuperLig2022, "2022-2023", "Turkey", "Super Lig", 1);
...
List<OnwardBaseFixture2020> GetFixtures2020(string season, string division)
{
    var file = new FileInfo($"{season}/{division}.csv");
    var onwardBaseFixture2020S = new List<OnwardBaseFixture2020>();
    ...
    var records = csv.GetRecords<OnwardBaseFixture2020>();
    onwardBaseFixture2020S.AddRange(records);

    return onwardBaseFixture2020S;
}
    ...
    foreach (var gameDay in onwardBaseFixturesByDate)
    {
        ...
        foreach (var fixture in gameDay)
        {
            try
            {
                ...
                for (var homeGoals = fixture.HTHG ?? 0; homeGoals < fixture.FTHG; homeGoals++)
                {
                    await soccerSimContext.LeagueFixtureEvents.AddAsync(new LeagueFixtureEvent
                    {
                        Season = season,
                ...
                for (var awayGoals = fixture.HTAG ?? 0; awayGoals < fixture.FTAG; awayGoals++)
                {
                    await soccerSimContext.LeagueFixtureEvents.AddAsync(new LeagueFixtureEvent
                    {
                        Season = season,
...
async Task StoreLeagueInfo2020(SoccerSimContext soccerSimContext, List<OnwardBaseFixture2020> fixtures, string season, string country, string div, int lvl)
{
    var continent = await soccerSimContext.Continents.FirstOrDefaultAsync(c => c.Season == season);
    if (continent == null)
    {
